...
if __name__ == '__main__':
    ...
    with open(r'C:\Users\Deeksha\Desktop\TrendPulse\Tp\tag_list.txt', 'r') as file:
        all_tags = file.readlines()
    tags_perImg = [x.strip() for x in all_tags]

    with open(r'C:\Users\Deeksha\Desktop\TrendPulse\Tp\data_list.txt', 'r') as file:
    ...
    # create train repo
    source = r'C:\Users\Deeksha\Desktop\TrendPulse\Tp\data_list.txt'
    dest = r'C:\Users\Deeksha\Desktop\TrendPulse\Tp\TRAIN'
    train_dict = {}
    i = 0
    ...
    for img, caption in zip(img_train, tags_train):
        ...
        full_name = os.path.join(source, comp[1], comp[2])  # Construct file path using os.path.join()
